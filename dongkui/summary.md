...
review 面向对象编程、并发编程、文件操作方面的代码;

由相关的老师做答疑、评价、指导和拓展;

##2、座谈
介绍和分析我们现在使用的技术、需要学习的技术(Go、Docker);

探讨需要学习的技术细节：用go语言实现高并发、负载均衡、web框架；

调整学习方式，修正练习计划，增强针对性和实战性，提高效率；

##3、确定下阶段主要学习方向和练习项目分工

结束上周的基础学习，开始项目实战练习；

团队成员明确不同的侧重方向，专攻一项，提高整体学习效率;

本周主要练习 Go Web 方面、Go 并发;

##4、Go Web 编程基础

##练习：
	开始练习项目：teamBuilder（主要练习 Go Web 、Go 并发）
